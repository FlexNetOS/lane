...
- [ ] Add `lane completions <shell>` subcommand (bash/zsh/fish/powershell) emitting a shell completion script via clap_complete; fully verifiable in an isolated HOME with no privilege.
